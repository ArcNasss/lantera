    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h3 class="text-xl font-bold text-gray-900">Rekap Data Denda</h3>
                    <p class="text-sm text-gray-600 mt-1">Laporan rekap denda dari pengembalian yang terlambat atau rusak/hilang</p>
                </div>
            </div>
