...
@section('content')
    <div class="bg-white rounded-lg shadow">
        ...
        <!-- Search & Filter -->
        <div class="p-6 border-b border-gray-200">
            <form method="GET" action="{{ route('admin.peminjaman.index') }}" class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.peminjaman.index') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-lg transition-colors">
                        Reset
                    </a>
                    @endif
                </div>
