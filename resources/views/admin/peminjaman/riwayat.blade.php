...
@section('content')
    ...
    <!-- Search & Filter -->
    <form method="GET" action="{{ route('admin.peminjaman.riwayat') }}" id="filter-form" class="flex items-center justify-between mb-5">
            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-cyan-500 text-white text-sm">
                        ...
                        <th class="px-5 py-3 text-center font-semibold">Petugas</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-16 text-center text-gray-400">
                            ...
                            <p class="text-sm mt-1">Data pengembalian buku akan muncul di sini</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
