...
@section('content')
                        ...
                        <td class="px-5 py-4 text-center">
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                @if($return->status == 'pending')
                                    <form action="{{ route('denda.paid', $return->id) }}" method="POST">
                                        @csrf
                                        <button type="submit"
    ...
    <div class="flex items-center justify-between mt-4">
        ...
        <div class="flex items-center gap-1">
            ...
            @else
                <a href="{{ $denda->previousPageUrl() }}" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 text-sm"><i class="fas fa-chevron-left text-xs"></i></a>
            @endif
            ...
            @if($denda->hasMorePages())
                <a href="{{ $denda->nextPageUrl() }}" class="w-8 h-8 flex items-center justify-center rounded-lg text-gray-600 bg-white border border-gray-200 hover:bg-gray-50 text-sm"><i class="fas fa-chevron-right text-xs"></i></a>
            @else
