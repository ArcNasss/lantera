...
@section('content')
    ...
    <!-- Reject Modal -->
    <div id="rejectModal" class="hidden fixed inset-0 bg-black/70 z-50 flex items-center justify-center">
        <div class="bg-white rounded-xl p-6 max-w-md w-full mx-4">
            <form id="rejectForm" method="POST">
                ...
                <textarea name="alasan_ditolak" rows="3" required
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 mb-4"
